...
```bash
cd packages/placeholder-package
...
1. Go to https://www.npmjs.com/package/placeholder-package/access
...
4. Fill in the form:
   - **Organization or user**: `placeholder-org`
...
```bash
git add .
git commit -m "chore: release placeholder-package v0.2.0"
git tag v0.2.0
...
**Full commit history**: https://github.com/placeholder-org/placeholder-repo/compare/vX.X.X...vY.Y.Y
```
...
pnpm check                              # Verify the repo is ready to release
pnpm release:changes                    # Review changes
# Write release-notes.md               # Summarize changes
# Edit packages/placeholder-package/package.json   # Bump version
git add . && git commit -m "chore: release placeholder-package v0.2.0"
git tag v0.2.0
git push && git push --tags
```
...
- Verify OIDC is configured: https://www.npmjs.com/package/placeholder-package/access
